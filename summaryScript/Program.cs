...
namespace parserExtentions
{
    class Program
    {
        ...
        static void ProcessFile(string filePath)
        {
            ...
            string pattern = @"(number of sequences of small complexity \d+ is: \d+|total number of sequences of complexity \d+ is: \d+)";
            ...
            using (StreamWriter nonZeroWriter = File.AppendText(Path.Combine(directoryPath, $"{complexity}_non_yielding_small_sequences.txt")))
            using (StreamWriter zeroWriter = File.AppendText(Path.Combine(directoryPath, $"{complexity}_yielding_small_sequences.txt")))
        ...
        static void GetSmallSeq(string fileContent, out List<string> yieldDb, out List<string> nonYieldDb)
        {
            ...
            string pattern = @"Debruijn Sequences generated by the sub sequence (\d+) : \s*the number of Debruijn sequences: (\d+)";
